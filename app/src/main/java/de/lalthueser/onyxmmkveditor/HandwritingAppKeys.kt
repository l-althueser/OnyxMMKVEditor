...
object HandwritingAppKeys {
    val AppKeys = listOf("eac_app_md.obsidian", "eac_app_md.xodo", "eac_app_com.drawboard.pdf")
    val ViewKeys = listOf("com.getcapacitor.CapacitorWebView", "com.pdftron.pdf.PDFViewCtrl", "com.getcapacitor.CapacitorWebView")
